...
![Correlation](https://user-images.githubusercontent.com/39437051/160256285-ef780147-24a2-45d7-9029-627c4d18b58a.png)


All the quantitative features, popularity, danceability, and instrumentalness have the highest associations, with popularity and danceability being positive and instrumentalness being negative. As a result, I will use these three features in my model.
<hr>
